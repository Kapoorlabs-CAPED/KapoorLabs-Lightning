...
# Run training with Adam optimizer and light transform preset
srun --unbuffered python lightning-oneat-adam.py \
    parameters.learning_rate=1.0e-3 \
    parameters.transform_preset=light \
    train_data_paths.log_path='/projects/extern/nhr/nhr_ni/nhr_ni_test/nhr_ni_test_27040/dir.project/oneat_mitosis_model_adam_light/' \
    train_data_paths.experiment_name='adam_light_aug'
